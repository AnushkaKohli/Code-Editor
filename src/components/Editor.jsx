...
const Editor = (props) => {
  ...
  return (
    <div
      className={`editor-container basis-0 flex flex-col p-2 bg-black ${
        open ? "grow" : "collapsed grow-0"
      }`}
    >
      ...
      <CodemirrorEditor
        ...
        value={value}
        className={`code-mirror-wrapper grow rounded-b-lg truncate text-${fontSize} `}
        options={{
          lineWrapping: true,
          lint: true,
          mode: language,
